...
import { id_pkix } from "x500-ts/dist/node/PkiPmiExternalDataTypes";
import {
    AttributeSet,
    SingleAttribute,
...
let _cached_decoder_for_OptionalValidity: __utils.ASN1Decoder<
    OptionalValidity
> | null = null;
let _cached_encoder_for_OptionalValidity: __utils.ASN1Encoder<
    OptionalValidity
> | null = null;
        ...
        _cached_decoder_for_OptionalValidity = function (
            ...
            const callbacks: __utils.DecodingMap = {
                notBefore: (_el: asn1.ASN1Element): void => {
                    notBefore = __utils._decode_implicit<Time>(
                        () => _decode_Time
                    )(_el);
                },
                notAfter: (_el: asn1.ASN1Element): void => {
                    notAfter = __utils._decode_implicit<Time>(
                        () => _decode_Time
                    )(_el);
                },
            };
...
export function _encode_OptionalValidity(
    ...
    elGetter: __utils.ASN1Encoder<OptionalValidity>
) {
...
let _cached_decoder_for_CertTemplate: __utils.ASN1Decoder<
    CertTemplate
> | null = null;
let _cached_encoder_for_CertTemplate: __utils.ASN1Encoder<
    CertTemplate
> | null = null;
        ...
        _cached_decoder_for_CertTemplate = function (
            ...
            const callbacks: __utils.DecodingMap = {
                version: (_el: asn1.ASN1Element): void => {
                    version = __utils._decode_implicit<Version>(
                        () => _decode_Version
                    )(_el);
                },
                serialNumber: (_el: asn1.ASN1Element): void => {
                    serialNumber = __utils._decode_implicit<asn1.INTEGER>(
                        () => __utils._decodeInteger
                    )(_el);
                },
                signingAlg: (_el: asn1.ASN1Element): void => {
                    signingAlg = __utils._decode_implicit<AlgorithmIdentifier>(
                        () => _decode_AlgorithmIdentifier
                    )(_el);
                },
                ...
                validity: (_el: asn1.ASN1Element): void => {
                    validity = __utils._decode_implicit<OptionalValidity>(
                ...
                publicKey: (_el: asn1.ASN1Element): void => {
                    publicKey = __utils._decode_implicit<SubjectPublicKeyInfo>(
                        () => _decode_SubjectPublicKeyInfo
                    )(_el);
                },
                issuerUID: (_el: asn1.ASN1Element): void => {
                    issuerUID = __utils._decode_implicit<UniqueIdentifier>(
                        () => _decode_UniqueIdentifier
                    )(_el);
                },
                subjectUID: (_el: asn1.ASN1Element): void => {
                    subjectUID = __utils._decode_implicit<UniqueIdentifier>(
                        () => _decode_UniqueIdentifier
                    )(_el);
                },
...
export function _encode_CertTemplate(
    value: CertTemplate,
    elGetter: __utils.ASN1Encoder<CertTemplate>
) {
...
export function _decode_Controls(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_Controls) {
        _cached_decoder_for_Controls = __utils._decodeSequenceOf<
            SingleAttribute
        >(() => _decode_SingleAttribute);
    }
...
export function _encode_Controls(
    ...
    if (!_cached_encoder_for_Controls) {
        _cached_encoder_for_Controls = __utils._encodeSequenceOf<
            SingleAttribute
...
let _cached_decoder_for_CertRequest: __utils.ASN1Decoder<
    CertRequest
> | null = null;
let _cached_encoder_for_CertRequest: __utils.ASN1Encoder<
    CertRequest
> | null = null;
export function _decode_CertRequest(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertRequest) {
        _cached_decoder_for_CertRequest = function (
            el: asn1.ASN1Element
        ): CertRequest {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                certTemplate: (_el: asn1.ASN1Element): void => {
...
export function _encode_CertRequest(
    value: CertRequest,
    elGetter: __utils.ASN1Encoder<CertRequest>
) {
                ...
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.controls === undefined
                            ? undefined
                            : _encode_Controls(value.controls, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_PKMACValue: __utils.ASN1Decoder<
    PKMACValue
> | null = null;
let _cached_encoder_for_PKMACValue: __utils.ASN1Encoder<
    PKMACValue
> | null = null;
export function _decode_PKMACValue(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKMACValue) {
        _cached_decoder_for_PKMACValue = function (
            el: asn1.ASN1Element
        ): PKMACValue {
...
export function _encode_PKMACValue(
    value: PKMACValue,
    elGetter: __utils.ASN1Encoder<PKMACValue>
) {
...
let _cached_decoder_for_POPOSigningKeyInput_authInfo: __utils.ASN1Decoder<
    POPOSigningKeyInput_authInfo
> | null = null;
let _cached_encoder_for_POPOSigningKeyInput_authInfo: __utils.ASN1Encoder<
    POPOSigningKeyInput_authInfo
> | null = null;
export function _decode_POPOSigningKeyInput_authInfo(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_POPOSigningKeyInput_authInfo) {
        _cached_decoder_for_POPOSigningKeyInput_authInfo = __utils._decode_inextensible_choice<
            POPOSigningKeyInput_authInfo
        >({
            "CONTEXT 0": [
                "sender",
...
export function _encode_POPOSigningKeyInput_authInfo(
    ...
    elGetter: __utils.ASN1Encoder<POPOSigningKeyInput_authInfo>
) {
    if (!_cached_encoder_for_POPOSigningKeyInput_authInfo) {
        _cached_encoder_for_POPOSigningKeyInput_authInfo = __utils._encode_choice<
            POPOSigningKeyInput_authInfo
        >(
            {
                sender: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    0,
                    () => _encode_GeneralName,
                    __utils.BER
...
let _cached_decoder_for_POPOSigningKeyInput: __utils.ASN1Decoder<
    POPOSigningKeyInput
> | null = null;
let _cached_encoder_for_POPOSigningKeyInput: __utils.ASN1Encoder<
    POPOSigningKeyInput
> | null = null;
...
export function _encode_POPOSigningKeyInput(
    ...
    elGetter: __utils.ASN1Encoder<POPOSigningKeyInput>
) {
...
let _cached_decoder_for_POPOSigningKey: __utils.ASN1Decoder<
    POPOSigningKey
> | null = null;
let _cached_encoder_for_POPOSigningKey: __utils.ASN1Encoder<
    POPOSigningKey
> | null = null;
export function _decode_POPOSigningKey(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_POPOSigningKey) {
        _cached_decoder_for_POPOSigningKey = function (
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                poposkInput: (_el: asn1.ASN1Element): void => {
                    poposkInput = __utils._decode_implicit<POPOSigningKeyInput>(
...
export function _encode_POPOSigningKey(
    ...
    elGetter: __utils.ASN1Encoder<POPOSigningKey>
) {
...
let _cached_decoder_for_SubsequentMessage: __utils.ASN1Decoder<
    SubsequentMessage
> | null = null;
let _cached_encoder_for_SubsequentMessage: __utils.ASN1Encoder<
    SubsequentMessage
> | null = null;
export function _decode_SubsequentMessage(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SubsequentMessage) {
        _cached_decoder_for_SubsequentMessage = __utils._decodeInteger;
    }
    return _cached_decoder_for_SubsequentMessage(el);
}
export function _encode_SubsequentMessage(
    value: SubsequentMessage,
    elGetter: __utils.ASN1Encoder<SubsequentMessage>
) {
    if (!_cached_encoder_for_SubsequentMessage) {
        _cached_encoder_for_SubsequentMessage = __utils._encodeInteger;
    }
...
let _cached_decoder_for_POPOPrivKey: __utils.ASN1Decoder<
    POPOPrivKey
> | null = null;
let _cached_encoder_for_POPOPrivKey: __utils.ASN1Encoder<
    POPOPrivKey
> | null = null;
export function _decode_POPOPrivKey(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_POPOPrivKey) {
        _cached_decoder_for_POPOPrivKey = __utils._decode_inextensible_choice<
            POPOPrivKey
        >({
            "CONTEXT 0": [
                "thisMessage",
                __utils._decode_implicit<asn1.BIT_STRING>(
                    () => __utils._decodeBitString
                ),
            ],
            "CONTEXT 1": [
                "subsequentMessage",
                __utils._decode_implicit<SubsequentMessage>(
            ...
            "CONTEXT 3": [
                "agreeMAC",
                __utils._decode_implicit<PKMACValue>(() => _decode_PKMACValue),
            ],
            "CONTEXT 4": [
                "encryptedKey",
                __utils._decode_implicit<EnvelopedData>(
                    () => _decode_EnvelopedData
                ),
            ],
        });
...
export function _encode_POPOPrivKey(
    value: POPOPrivKey,
    elGetter: __utils.ASN1Encoder<POPOPrivKey>
) {
    if (!_cached_encoder_for_POPOPrivKey) {
        _cached_encoder_for_POPOPrivKey = __utils._encode_choice<POPOPrivKey>(
            {
                thisMessage: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    0,
                    () => __utils._encodeBitString,
                    __utils.BER
                ),
                subsequentMessage: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    1,
                    () => _encode_SubsequentMessage,
                    __utils.BER
                ),
                dhMAC: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    2,
                    () => __utils._encodeBitString,
                    __utils.BER
                ),
                agreeMAC: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    3,
                    () => _encode_PKMACValue,
                    __utils.BER
                ),
                encryptedKey: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    4,
                    () => _encode_EnvelopedData,
                    __utils.BER
...
let _cached_decoder_for_ProofOfPossession: __utils.ASN1Decoder<
    ProofOfPossession
> | null = null;
let _cached_encoder_for_ProofOfPossession: __utils.ASN1Encoder<
    ProofOfPossession
> | null = null;
export function _decode_ProofOfPossession(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ProofOfPossession) {
        _cached_decoder_for_ProofOfPossession = __utils._decode_inextensible_choice<
            ProofOfPossession
        >({
            "CONTEXT 0": [
                "raVerified",
            ...
            "CONTEXT 1": [
                "signature",
                __utils._decode_implicit<POPOSigningKey>(
                    () => _decode_POPOSigningKey
                ),
            ],
            "CONTEXT 2": [
                "keyEncipherment",
                __utils._decode_implicit<POPOPrivKey>(
                    () => _decode_POPOPrivKey
                ),
            ],
            "CONTEXT 3": [
...
export function _encode_ProofOfPossession(
    ...
    elGetter: __utils.ASN1Encoder<ProofOfPossession>
) {
    if (!_cached_encoder_for_ProofOfPossession) {
        _cached_encoder_for_ProofOfPossession = __utils._encode_choice<
            ProofOfPossession
        >(
            {
                raVerified: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    0,
                    () => __utils._encodeNull,
                    __utils.BER
                ),
                signature: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    1,
                    () => _encode_POPOSigningKey,
                    __utils.BER
                ),
                keyEncipherment: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    2,
                    () => _encode_POPOPrivKey,
                    __utils.BER
                ),
                keyAgreement: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    3,
                    () => _encode_POPOPrivKey,
                    __utils.BER
...
let _cached_decoder_for_CertReqMsg: __utils.ASN1Decoder<
    CertReqMsg
> | null = null;
let _cached_encoder_for_CertReqMsg: __utils.ASN1Encoder<
    CertReqMsg
> | null = null;
export function _decode_CertReqMsg(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertReqMsg) {
        _cached_decoder_for_CertReqMsg = function (
            el: asn1.ASN1Element
        ): CertReqMsg {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                popo: (_el: asn1.ASN1Element): void => {
                    popo = _decode_ProofOfPossession(_el);
                },
                regInfo: (_el: asn1.ASN1Element): void => {
                    regInfo = __utils._decodeSequenceOf<SingleAttribute>(
                        () => _decode_SingleAttribute
                    )(_el);
                },
            };
...
export function _encode_CertReqMsg(
    value: CertReqMsg,
    elGetter: __utils.ASN1Encoder<CertReqMsg>
) {
                ...
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.regInfo === undefined
                            ? undefined
                            : __utils._encodeSequenceOf<SingleAttribute>(
                                  () => _encode_SingleAttribute,
                                  __utils.BER
                              )(value.regInfo, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_CertReqMessages: __utils.ASN1Decoder<
    CertReqMessages
> | null = null;
let _cached_encoder_for_CertReqMessages: __utils.ASN1Encoder<
    CertReqMessages
> | null = null;
export function _decode_CertReqMessages(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertReqMessages) {
        _cached_decoder_for_CertReqMessages = __utils._decodeSequenceOf<
            CertReqMsg
        >(() => _decode_CertReqMsg);
    }
...
export function _encode_CertReqMessages(
    ...
    elGetter: __utils.ASN1Encoder<CertReqMessages>
) {
    if (!_cached_encoder_for_CertReqMessages) {
        _cached_encoder_for_CertReqMessages = __utils._encodeSequenceOf<
            CertReqMsg
        >(() => _encode_CertReqMsg, __utils.BER);
    }
...
export function _decode_Attributes(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_Attributes) {
        _cached_decoder_for_Attributes = __utils._decodeSetOf<AttributeSet>(
            () => _decode_AttributeSet
        );
    }
...
export function _encode_Attributes(
    ...
    if (!_cached_encoder_for_Attributes) {
        _cached_encoder_for_Attributes = __utils._encodeSetOf<AttributeSet>(
            () => _encode_AttributeSet,
            __utils.BER
        );
    }
...
export function _decode_PrivateKeyInfo(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PrivateKeyInfo) {
        _cached_decoder_for_PrivateKeyInfo = function (
            ...
            const callbacks: __utils.DecodingMap = {
                version: (_el: asn1.ASN1Element): void => {
                    version = __utils._decodeInteger(_el);
                },
                ...
                privateKey: (_el: asn1.ASN1Element): void => {
                    privateKey = __utils._decodeOctetString(_el);
                },
...
let _cached_decoder_for_EncKeyWithID_identifier: __utils.ASN1Decoder<
    EncKeyWithID_identifier
> | null = null;
let _cached_encoder_for_EncKeyWithID_identifier: __utils.ASN1Encoder<
    EncKeyWithID_identifier
> | null = null;
export function _decode_EncKeyWithID_identifier(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_EncKeyWithID_identifier) {
        _cached_decoder_for_EncKeyWithID_identifier = __utils._decode_inextensible_choice<
            EncKeyWithID_identifier
        >({
...
export function _encode_EncKeyWithID_identifier(
    ...
    elGetter: __utils.ASN1Encoder<EncKeyWithID_identifier>
) {
    if (!_cached_encoder_for_EncKeyWithID_identifier) {
        _cached_encoder_for_EncKeyWithID_identifier = __utils._encode_choice<
            EncKeyWithID_identifier
        >(
            {
...
let _cached_decoder_for_EncKeyWithID: __utils.ASN1Decoder<
    EncKeyWithID
> | null = null;
let _cached_encoder_for_EncKeyWithID: __utils.ASN1Encoder<
    EncKeyWithID
> | null = null;
...
export function _encode_EncKeyWithID(
    value: EncKeyWithID,
    elGetter: __utils.ASN1Encoder<EncKeyWithID>
) {
...
export function _decode_RegToken(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RegToken) {
        _cached_decoder_for_RegToken = __utils._decodeUTF8String;
    }
    return _cached_decoder_for_RegToken(el);
}
export function _encode_RegToken(
    value: RegToken,
    elGetter: __utils.ASN1Encoder<RegToken>
) {
    if (!_cached_encoder_for_RegToken) {
        _cached_encoder_for_RegToken = __utils._encodeUTF8String;
    }
...
export function _decode_Authenticator(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_Authenticator) {
        _cached_decoder_for_Authenticator = __utils._decodeUTF8String;
    }
...
export function _encode_Authenticator(
    ...
    if (!_cached_encoder_for_Authenticator) {
        _cached_encoder_for_Authenticator = __utils._encodeUTF8String;
    }
...
let _cached_decoder_for_PKIPublicationInfo_action: __utils.ASN1Decoder<
    PKIPublicationInfo_action
> | null = null;
let _cached_encoder_for_PKIPublicationInfo_action: __utils.ASN1Encoder<
    PKIPublicationInfo_action
> | null = null;
export function _decode_PKIPublicationInfo_action(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIPublicationInfo_action) {
        _cached_decoder_for_PKIPublicationInfo_action = __utils._decodeInteger;
    }
...
export function _encode_PKIPublicationInfo_action(
    ...
    elGetter: __utils.ASN1Encoder<PKIPublicationInfo_action>
) {
    if (!_cached_encoder_for_PKIPublicationInfo_action) {
        _cached_encoder_for_PKIPublicationInfo_action = __utils._encodeInteger;
    }
...
let _cached_decoder_for_SinglePubInfo_pubMethod: __utils.ASN1Decoder<
    SinglePubInfo_pubMethod
> | null = null;
let _cached_encoder_for_SinglePubInfo_pubMethod: __utils.ASN1Encoder<
    SinglePubInfo_pubMethod
> | null = null;
export function _decode_SinglePubInfo_pubMethod(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SinglePubInfo_pubMethod) {
        _cached_decoder_for_SinglePubInfo_pubMethod = __utils._decodeInteger;
    }
...
export function _encode_SinglePubInfo_pubMethod(
    ...
    elGetter: __utils.ASN1Encoder<SinglePubInfo_pubMethod>
) {
    if (!_cached_encoder_for_SinglePubInfo_pubMethod) {
        _cached_encoder_for_SinglePubInfo_pubMethod = __utils._encodeInteger;
    }
...
let _cached_decoder_for_SinglePubInfo: __utils.ASN1Decoder<
    SinglePubInfo
> | null = null;
let _cached_encoder_for_SinglePubInfo: __utils.ASN1Encoder<
    SinglePubInfo
> | null = null;
export function _decode_SinglePubInfo(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SinglePubInfo) {
        _cached_decoder_for_SinglePubInfo = function (
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                pubMethod: (_el: asn1.ASN1Element): void => {
                    pubMethod = _decode_SinglePubInfo_pubMethod(_el);
                },
                pubLocation: (_el: asn1.ASN1Element): void => {
...
export function _encode_SinglePubInfo(
    value: SinglePubInfo,
    elGetter: __utils.ASN1Encoder<SinglePubInfo>
) {
...
let _cached_decoder_for_PKIPublicationInfo: __utils.ASN1Decoder<
    PKIPublicationInfo
> | null = null;
let _cached_encoder_for_PKIPublicationInfo: __utils.ASN1Encoder<
    PKIPublicationInfo
> | null = null;
export function _decode_PKIPublicationInfo(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIPublicationInfo) {
        _cached_decoder_for_PKIPublicationInfo = function (
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                action: (_el: asn1.ASN1Element): void => {
                    action = _decode_PKIPublicationInfo_action(_el);
                },
                pubInfos: (_el: asn1.ASN1Element): void => {
                    pubInfos = __utils._decodeSequenceOf<SinglePubInfo>(
...
export function _encode_PKIPublicationInfo(
    ...
    elGetter: __utils.ASN1Encoder<PKIPublicationInfo>
) {
                ...
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.pubInfos === undefined
                            ? undefined
                            : __utils._encodeSequenceOf<SinglePubInfo>(
                                  () => _encode_SinglePubInfo,
                                  __utils.BER
                              )(value.pubInfos, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_EncryptedValue: __utils.ASN1Decoder<
    EncryptedValue
> | null = null;
let _cached_encoder_for_EncryptedValue: __utils.ASN1Encoder<
    EncryptedValue
> | null = null;
export function _decode_EncryptedValue(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_EncryptedValue) {
        _cached_decoder_for_EncryptedValue = function (
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                intendedAlg: (_el: asn1.ASN1Element): void => {
                    intendedAlg = __utils._decode_implicit<AlgorithmIdentifier>(
                        () => _decode_AlgorithmIdentifier
                    )(_el);
                },
                symmAlg: (_el: asn1.ASN1Element): void => {
                    symmAlg = __utils._decode_implicit<AlgorithmIdentifier>(
                        () => _decode_AlgorithmIdentifier
                    )(_el);
                },
                encSymmKey: (_el: asn1.ASN1Element): void => {
                    encSymmKey = __utils._decode_implicit<asn1.BIT_STRING>(
                        () => __utils._decodeBitString
                    )(_el);
                },
                keyAlg: (_el: asn1.ASN1Element): void => {
                    keyAlg = __utils._decode_implicit<AlgorithmIdentifier>(
                        () => _decode_AlgorithmIdentifier
                    )(_el);
                },
                valueHint: (_el: asn1.ASN1Element): void => {
                    valueHint = __utils._decode_implicit<asn1.OCTET_STRING>(
                        () => __utils._decodeOctetString
                    )(_el);
                },
                encValue: (_el: asn1.ASN1Element): void => {
                    encValue = __utils._decodeBitString(_el);
                },
            };
            /* END_OF_CALLBACKS_MAP */
            __utils._parse_sequence(
...
export function _encode_EncryptedValue(
    ...
    elGetter: __utils.ASN1Encoder<EncryptedValue>
) {
...
export function _decode_EncryptedKey(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_EncryptedKey) {
        _cached_decoder_for_EncryptedKey = __utils._decode_inextensible_choice<
            EncryptedKey
        >({
...
export function _encode_EncryptedKey(
    ...
    if (!_cached_encoder_for_EncryptedKey) {
        _cached_encoder_for_EncryptedKey = __utils._encode_choice<EncryptedKey>(
            {
                encryptedValue: _encode_EncryptedValue,
                envelopedData: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    0,
                    () => _encode_EnvelopedData,
                    __utils.BER
...
let _cached_decoder_for_KeyGenParameters: __utils.ASN1Decoder<
    KeyGenParameters
> | null = null;
let _cached_encoder_for_KeyGenParameters: __utils.ASN1Encoder<
    KeyGenParameters
> | null = null;
export function _decode_KeyGenParameters(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_KeyGenParameters) {
        _cached_decoder_for_KeyGenParameters = __utils._decodeOctetString;
    }
    return _cached_decoder_for_KeyGenParameters(el);
}
export function _encode_KeyGenParameters(
    value: KeyGenParameters,
    elGetter: __utils.ASN1Encoder<KeyGenParameters>
) {
    if (!_cached_encoder_for_KeyGenParameters) {
        _cached_encoder_for_KeyGenParameters = __utils._encodeOctetString;
    }
...
let _cached_decoder_for_PKIArchiveOptions: __utils.ASN1Decoder<
    PKIArchiveOptions
> | null = null;
let _cached_encoder_for_PKIArchiveOptions: __utils.ASN1Encoder<
    PKIArchiveOptions
> | null = null;
export function _decode_PKIArchiveOptions(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIArchiveOptions) {
        _cached_decoder_for_PKIArchiveOptions = __utils._decode_inextensible_choice<
            PKIArchiveOptions
        >({
            "CONTEXT 0": [
                "encryptedPrivKey",
                __utils._decode_implicit<EncryptedKey>(
                    () => _decode_EncryptedKey
                ),
            ],
            "CONTEXT 1": [
                "keyGenParameters",
                __utils._decode_implicit<KeyGenParameters>(
                    () => _decode_KeyGenParameters
                ),
            ],
            "CONTEXT 2": [
                "archiveRemGenPrivKey",
                __utils._decode_implicit<asn1.BOOLEAN>(
...
export function _encode_PKIArchiveOptions(
    ...
    elGetter: __utils.ASN1Encoder<PKIArchiveOptions>
) {
    if (!_cached_encoder_for_PKIArchiveOptions) {
        _cached_encoder_for_PKIArchiveOptions = __utils._encode_choice<
            PKIArchiveOptions
        >(
            {
                encryptedPrivKey: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    0,
                    () => _encode_EncryptedKey,
                    __utils.BER
                ),
                keyGenParameters: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    1,
                    () => _encode_KeyGenParameters,
                    __utils.BER
                ),
                archiveRemGenPrivKey: __utils._encode_implicit(
                    asn1.ASN1TagClass.context,
                    2,
...
export function _encode_OldCertId(
    value: OldCertId,
    elGetter: __utils.ASN1Encoder<OldCertId>
) {
...
let _cached_decoder_for_ProtocolEncrKey: __utils.ASN1Decoder<
    ProtocolEncrKey
> | null = null;
let _cached_encoder_for_ProtocolEncrKey: __utils.ASN1Encoder<
    ProtocolEncrKey
> | null = null;
...
export function _encode_ProtocolEncrKey(
    ...
    elGetter: __utils.ASN1Encoder<ProtocolEncrKey>
) {
...
export function _decode_UTF8Pairs(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_UTF8Pairs) {
        _cached_decoder_for_UTF8Pairs = __utils._decodeUTF8String;
    }
    return _cached_decoder_for_UTF8Pairs(el);
}
export function _encode_UTF8Pairs(
    value: UTF8Pairs,
    elGetter: __utils.ASN1Encoder<UTF8Pairs>
) {
    if (!_cached_encoder_for_UTF8Pairs) {
        _cached_encoder_for_UTF8Pairs = __utils._encodeUTF8String;
    }
